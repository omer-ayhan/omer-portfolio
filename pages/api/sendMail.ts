...
async function sendEmail(req: NextApiRequest, res: NextApiResponse) {
  switch (req.method) {
    case "POST":
      ...
      try {
        await sendgrid.send({
          to: "om.ay247@gmail.com", // Your email where you'll receive emails
          from: "omya123@gmail.com", // your website email address here
        ...
        <body>
          <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
                ...
                <p class="footer" style="font-size: 16px;padding-bottom: 20px;border-bottom: 1px solid #D1D5DB;">Regards<br>Ömer Ayhan<br>Software Developer</p>
